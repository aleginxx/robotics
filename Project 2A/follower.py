...
class mymobibot_follower():
    ...
    def __init__(self, rate):
        ...
        self.output_file.write("Time, Sonar_FR, Sonar_R, Linear_Velocity_X, Angular_Velocity_Z, Front_Right_Error, Right_Error\n")
    ...
    def publish(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.output_file.write(f"{rostime_now.to_sec()}, {self.sonar_FR.range}, {self.sonar_R.range}, {self.velocity.linear.x}, {self.velocity.angular.z}, {front_right_error}, {right_error}\n")
